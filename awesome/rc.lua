...
beautiful.init("/home/nullcore/.config/awesome/theme.lua")
beautiful.get().wallpaper = "/home/nullcore/Documents/images/background-wizard.png"
...
gears.timer {
    ...
    call_now = true,
    callback = function()
        mytextclock:set_time(os.date(" %a %d %b %Y | %H:%M:%S"))
    end
}
        ...
        {
            {
                ...
                align  = "center",
                valign = "center",
                font   = "Sans 33"  -- set your font here
            },
...
-- Add widgets to the wibox
    ...
    s.mySecondWibox = awful.wibar({
        ontop = true, screen = s,
        width = 100, height = 40,
    
    })
    s.mySecondWibox:geometry({
        width = 200,
        height = 30,
    })
    s.mySecondWibox:setup {
        layout = wibox.layout.align.horizontal,
        widget = wibox.container.margin,
        ontop = 0,
    }
